...
.data
;n dw 6
n1  DB 'Enter a input number :$'
n2  DB 0DH,0AH,'The output is :$'
...
main proc
    ...
    LEA DX, n1             ; load and display the string PROMPT_2
    MOV AH, 9 
    INT 21H
    ...
    call fib                     ; push AX onto the STACK

    LEA DX, n2             ; load and display the string PROMPT_2
    MOV AH, 9 
    INT 21H
